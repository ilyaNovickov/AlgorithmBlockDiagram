...
namespace GSAVelLib
{
    ...
    public class Diagram
    {
        ...
        public void AddComment()
        {
            ...
            elements.Add(new AreaWithText());
        }
        /// <summary>
        /// Добавления комментария в блок-схему
        /// </summary>
        public void AddComment(AreaWithText comment)
        {
            //Добавление комментария в блок-схему
        ...
        #endregion
        #region Метод перемещения элемента на передний/задний план
        /// <summary>
        /// Перемещение элемента блок-схемы на передний план
        /// </summary>
        /// <param name="element"></param>
        public void ToForeground(IDiagramElement element)
        {
            //Если элемента нет в блок-схемы или он - последний в списке элементов
            if (elements.IndexOf(element) == -1 || elements.IndexOf(element) == elements.Count - 1)
                return;//Выйти из метода
            //Вспомогательная переменная для перемещения элементов в блок-схемы
        ...
        /// <summary>
        /// Перемещение элемента блок-схемы на задний план
        /// </summary>
        /// <param name="element"></param>
        public void ToBackground(IDiagramElement element)
        {
            //Если элемента нет в блок-схемы или он - первый в списке элементов
            if (elements.IndexOf(element) == -1 || elements.IndexOf(element) == 0)
                return;//Выйти из метода
            //Вспомогательная переменная для перемещения элементов в блок-схемы
            IDiagramElement diagElem = elements[elements.IndexOf(element) - 1];
            //Вспомиогательная переменная с индексом перемещяемого элемента
            int index = elements.IndexOf(element);
            //Перемещение элемента
            elements[elements.IndexOf(element) - 1] = element;
            elements[index] = diagElem;
        }
        #endregion
